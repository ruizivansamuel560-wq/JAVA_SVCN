...
<head>
    ...
    <title>SVCN Style - Panel de <%= admin.getNombre() %></title>
    ...
    <div class="dashboard-layout">
        <aside class="sidebar">
            ...
            <ul>
                ...
                <li><a href="reports.jsp">Reportes</a></li>
        ...
        <main class="main-content">
            <h2 class="section-title" style="text-align: left; padding-top: 0;">Bienvenido, <%= admin.getNombre() %></h2>
            <p>Acceso rápido a las principales funcionalidades de administración. Tu rol es: **<%= admin.getRol() %>**</p>
            ...
            <div class="dashboard-cards">
                ...
                <div class="dashboard-card">
                    ...
                    <a href="reports.jsp" class="button primary-button">Ver Reportes</a>
                </div>
                <div class="dashboard-card">
